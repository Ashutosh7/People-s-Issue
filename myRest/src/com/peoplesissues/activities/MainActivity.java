...
public class MainActivity extends FragmentActivity implements ChangeLinkListener {
	...
	public void onLinkChange(Listdata data) {
		...
		/*if(findViewById(R.id.fragFrame)!=null){
			//set item checked ; how??

			DetailFragment df = (DetailFragment) getFragmentManager().findFragmentById(R.id.fragFrame);
			if(df==null /*|| shown index != curindex )/*{
				df = new DetailFragment();
				df.init();
				FragmentTransaction ft= getFragmentManager().beginTransaction();
				ft.replace(R.id.fragFrame, df);
		...
		Intent i = new Intent(MainActivity.this, HttpConnectSample.class);
